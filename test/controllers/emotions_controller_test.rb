...
class EmotionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create emotion" do
    assert_difference('Emotion.count') do
      post emotions_url, params: { emotion: { description: @emotion.description, titre: @emotion.titre } }
    end
  ...
  test "should update emotion" do
    patch emotion_url(@emotion), params: { emotion: { description: @emotion.description, titre: @emotion.titre } }
